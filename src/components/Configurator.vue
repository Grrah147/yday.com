<template>
    <div id="configurator-container"
        class="flex-auto flex flex-col justify-center items-start gap-2 pt-1 font-medium rounded">
        <ShelfTemplatesUI />
        <div class="card w-full">
            <Panel toggleable>
                ...
                <div id="configurator-scene-container"
                    class="w-full h-[500px] relative p-4 bg-surface-100 dark:bg-surface-950 rounded-md">
